    ...
    private void MainWindowUI(int windowId)
    {
        ...
        { // Main Window Area
            ...
            GUILayout.BeginVertical();
            {
                ...
                {
                    // Elements defined here will be place after each other
                    var toggle_imode = GameManager.Instance.interactiveMode;
                    toggle_imode = GUILayout.Toggle(toggle_imode, "Interactive Mode");
                    if (GUI.changed)
                    { GameManager.Instance.interactiveMode = toggle_imode; }
                }
                GUILayout.EndHorizontal();
                ...
                {
                    // Elements defined here will be place after each other
                    var toggle_sound = SoundManager.Instance.masterMuted;
                    toggle_sound = GUILayout.Toggle(toggle_sound, "Mute sound");
                    if (GUI.changed)
                    { SoundManager.Instance.masterMuted = toggle_sound; }
                }
                GUILayout.EndHorizontal();
